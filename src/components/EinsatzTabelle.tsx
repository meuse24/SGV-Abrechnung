  ...
  return (
    <section className="card">
      ...
      <table className="table">
        <thead>
          <tr>
            <th onClick={() => onSortChange("bezeichnung")}>Bezeichnung</th>
            <th onClick={() => onSortChange("artDerKraefte")}>Art</th>
            <th onClick={() => onSortChange("anzahl")}>Anzahl</th>
            <th onClick={() => onSortChange("datum")}>Datum</th>
            <th onClick={() => onSortChange("beginn")}>Beginn</th>
            <th onClick={() => onSortChange("ende")}>Ende</th>
            <th>T1</th>
            <th>T2</th>
            <th onClick={() => onSortChange("gesamtkosten")}>Kosten</th>
            <th>Aktionen</th>
          </tr>
        </thead>
        <tbody>
