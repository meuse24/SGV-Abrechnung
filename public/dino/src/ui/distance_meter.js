...
import { IS_HIDPI, IS_RTL } from '../config/constants.js';
...
export class DistanceMeter {
    ...
    draw(digitPos, value, highScore) {
        ...
        // Apply bright red color filter to score display
        this.canvasCtx.filter = 'sepia(100%) saturate(900%) brightness(130%) hue-rotate(350deg)';
...
//# sourceMappingURL=distance_meter.js.map
