...
import { FPS, IS_HIDPI } from '../config/constants.js';
export class HorizonLine {
    ...
    draw() {
        ...
        // Apply green color filter to the ground
        this.canvasCtx.save();
        this.canvasCtx.filter = 'sepia(100%) saturate(500%) brightness(80%) hue-rotate(60deg)';
...
//# sourceMappingURL=horizon_line.js.map