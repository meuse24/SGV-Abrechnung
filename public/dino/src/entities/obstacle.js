...
import { FPS, IS_HIDPI, IS_MOBILE } from '../config/constants.js';
...
export class Obstacle {
    ...
    draw() {
        ...
        const isCactus = this.typeConfig.type.startsWith('cactus');
        // Apply bright green color filter to cacti only
        this.canvasCtx.save();
        if (isCactus) {
            this.canvasCtx.filter = 'sepia(100%) saturate(900%) brightness(135%) hue-rotate(90deg)';
        }
